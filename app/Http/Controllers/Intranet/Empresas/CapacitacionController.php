...
class CapacitacionController extends Controller
{
    ...
    public function index($id)
    {
        ...
        return view('intranet.empresa.archivo.capacitaciones.index', compact('empleados', 'id'));
    }
    ...
    public function crear($id)
    {
        ...
        return view('intranet.empresa.archivo.capacitaciones.crear', compact('empleado'));
    }
    /**
    ...
    public function guardar(Request $request, $id)
    {
        ...
        $nuevo_soporte['tipo'] = 'capacitacion';
        ...
        $empleado = Empleado::findOrFail($id);
        $soportes = HvDocumento::where('tipo', 'capacitacion')->where('empleado_id', $id)->get();
        return redirect('admin/archivo-capacitacion/' . $id . '/editar')->with('mensaje', 'Soporte creado con exito')->with('empleado')->with('soportes');
    }
    ...
    public function editar($id)
    {
        $empleado = Empleado::findOrFail($id);
        $soportes = HvDocumento::where('tipo', 'capacitacion')->where('empleado_id', $id)->get();
        return view('intranet.empresa.archivo.capacitaciones.editar', compact('empleado', 'soportes'));
    }
