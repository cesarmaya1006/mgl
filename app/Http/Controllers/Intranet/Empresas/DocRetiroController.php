...
class DocRetiroController extends Controller
{
    ...
    public function index($id)
    {
        ...
        return view('intranet.empresa.archivo.doc_retiro.index', compact('empleados', 'id'));
    }
    ...
    public function crear($id)
    {
        ...
        return view('intranet.empresa.archivo.doc_retiro.crear', compact('empleado'));
    }
    ...
    public function guardar(Request $request, $id)
    {
        ...
        $empleado = Empleado::findOrFail($id);
        $soportes = HvDocumento::where('tipo', 'doc_retiro')->where('empleado_id', $id)->get();
        return redirect('admin/archivo-doc_retiro/' . $id . '/editar')->with('mensaje', 'Soporte creado con exito')->with('empleado')->with('soportes');
    }
    ...
    public function editar($id)
    {
        $empleado = Empleado::findOrFail($id);
        $soportes = HvDocumento::where('tipo', 'doc_retiro')->where('empleado_id', $id)->get();
        return view('intranet.empresa.archivo.doc_retiro.editar', compact('empleado', 'soportes'));
    }
