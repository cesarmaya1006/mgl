...
class DotacionesController extends Controller
{
    /**
    ...
    public function index($id)
    {
        ...
        return view('intranet.empresa.archivo.dotaciones.index', compact('empleados', 'id'));
    }
    ...
    public function crear($id)
    {
        ...
        return view('intranet.empresa.archivo.dotaciones.crear', compact('empleado'));
    }
    /**
    ...
    public function guardar(Request $request, $id)
    {
        ...
        $empleado = Empleado::findOrFail($id);
        $soportes = HvDocumento::where('tipo', 'dotacion')->where('empleado_id', $id)->get();
        return redirect('admin/archivo-dotaciones/' . $id . '/editar')->with('mensaje', 'Documento creado con exito')->with('empleado')->with('soportes');
    }
    ...
    public function editar($id)
    {
        $empleado = Empleado::findOrFail($id);
        $soportes = HvDocumento::where('tipo', 'dotacion')->where('empleado_id', $id)->get();
        return view('intranet.empresa.archivo.dotaciones.editar', compact('empleado', 'soportes'));
    }
