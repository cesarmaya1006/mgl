...
class VacacionesController extends Controller
{
    ...
    public function index($id)
    {
        ...
        return view('intranet.empresa.archivo.vacaciones.index', compact('empleados', 'id'));
    }
    ...
    public function crear($id)
    {
        ...
        return view('intranet.empresa.archivo.vacaciones.crear', compact('empleado'));
    }
    ...
    public function guardar(Request $request, $id)
    {
        ...
        $empleado = Empleado::findOrFail($id);
        $soportes = HvDocumento::where('tipo', 'vacaciones')->where('empleado_id', $id)->get();
        return redirect('admin/archivo-vacaciones/' . $id . '/editar')->with('mensaje', 'Soporte creado con exito')->with('empleado')->with('soportes');
    }
    /**
    ...
    public function editar($id)
    {
        $empleado = Empleado::findOrFail($id);
        $soportes = HvDocumento::where('tipo', 'vacaciones')->where('empleado_id', $id)->get();
        return view('intranet.empresa.archivo.vacaciones.editar', compact('empleado', 'soportes'));
    }
