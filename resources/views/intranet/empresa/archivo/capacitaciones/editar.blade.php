                                ...
                                @foreach ($soportes as $soporte)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <form action="{{ route('capacitacion-eliminar', ['id' => $soporte->id]) }}"
