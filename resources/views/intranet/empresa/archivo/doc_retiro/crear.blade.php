        ...
        <div class="card-header">
            <div class="row mb-3">
                <div class="col-12 col-md-8 col-lg-8 text-md-left text-lg-left pl-2">
                    <h5>Nuevo Documento de Retiro: {{ $empleado->primer_nombre }} {{ $empleado->segundo_nombre }}
                ...
                <div class="col-12 col-md-4 col-lg-4 text-md-right text-lg-right pl-2 pr-md-5 pr-lg-5">
                    <a href="{{ route('doc_retiro-editar', ['id' => $empleado->id]) }}"
            ...
            <form class="row d-flex justify-content-around"
                action="{{ route('doc_retiro-guardar', ['id' => $empleado->id]) }}" method="POST" autocomplete="off"
