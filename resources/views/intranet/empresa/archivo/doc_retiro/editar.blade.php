        ...
        <div class="card-header">
            <div class="row mb-3">
                <div class="col-12 col-md-6 col-lg-6 text-md-left text-lg-left pl-2">
                    <h5>Documentos de Retiro: {{ $empleado->usuario->nombres . ' ' . $empleado->usuario->apellidos }}</h5>
                </div>
                <div class="col-12 col-md-6 col-lg-6 text-md-right text-lg-right pl-2 pr-md-5 pr-lg-5">
                    <a href="{{ route('doc_retiro-index', ['id' => $empleado->empresa->id]) }}"
                        class="btn btn-info btn-sm text-center pl-3 pr-3 mr-3" style="font-size: 0.9em;"><i
                            class="fas fa-undo-alt mr-2"></i>Volver</a>
                    <a href="{{ route('doc_retiro-crear', ['id' => $empleado->id]) }}"
                                ...
                                @foreach ($soportes as $soporte)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <form action="{{ route('doc_retiro-eliminar', ['id' => $soporte->id]) }}"
