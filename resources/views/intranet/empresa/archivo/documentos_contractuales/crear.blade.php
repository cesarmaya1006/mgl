        ...
        <div class="card-header">
            <div class="row mb-3">
                <div class="col-12 col-md-8 col-lg-8 text-md-left text-lg-left pl-2">
                    <h5>Nuevo Documento contractual: {{ $empleado->primer_nombre }} {{ $empleado->segundo_nombre }}
                ...
                <div class="col-12 col-md-4 col-lg-4 text-md-right text-lg-right pl-2 pr-md-5 pr-lg-5">
                    <a href="{{ route('documentoscontractuales-editar', ['id' => $empleado->id]) }}"
            ...
            <form class="row d-flex justify-content-around"
                action="{{ route('documentoscontractuales-guardar', ['id' => $empleado->id]) }}" method="POST"
...
@section('scripts_pagina')
    <script src="{{ asset('js/admin/archivo/soportes.js') }}"></script>
@endsection
<!-- ************************************************************* -->
