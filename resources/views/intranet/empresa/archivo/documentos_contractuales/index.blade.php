        ...
        <div class="card-header">
            <div class="row mb-3">
                <div class="col-12 col-md-6 col-lg-6 text-md-left text-lg-left pl-2">
                    <h5>Documentos contractuales</h5>
                </div>
                        ...
                        <div class="row row d-flex justify-content-around mt-3">
                            <div class="col-10 col-md-5">
                                <div class="form-group">
                                  ...
                                  <input type="text" name="apellido" id="apellido" class="form-control" data_url="{{ route('soportes_afiliacion-filtar') }}" ruta_editar="{{ route('documentoscontractuales-editar', ['id' => 1]) }}" placeholder="" aria-describedby="helpId">
                                </div>
                            </div>
                        </div>
                        <hr>
                            ...
                            @foreach ($empleados as $empleado)
                                <tr>
                                    ...
                                    <td class="text-center"><a
                                            href="{{ route('documentoscontractuales-editar', ['id' => $empleado->id]) }}"
