        ...
        <div class="card-header">
            <div class="row mb-3">
                <div class="col-12 col-md-6 col-lg-6 text-md-left text-lg-left pl-2">
                    <h5>Editar Educación Superior {{ $empleado->usuario->nombres . ' ' . $empleado->usuario->apellidos }}
                    </h5>
                </div>
            ...
            <div class="row d-flex justify-content-around mt-3 mb-4" id="listado_empleados">
                <div class="col-12 col-md-11">
                    ...
                    <form class="row d-flex justify-content-around pt-3 pb-3 pl-5 form-horizontal"
                        action="{{ route('hojas_de_vida-edusuperior-guardar', ['id' => $empleado->id]) }}"
                        autocomplete="off" enctype="multipart/form-data" method="POST"
                        style="font-size: 0.8em;background-color: #ffffff">
                        @csrf
                        @method('post')
                        <div class="col-12 mb-3">
                            <h6 style="text-decoration: underline;"><strong>Eduación Superior</strong></h6>
                        </div>
                        <div class="col-12">
                            <div class="row d-flex justify-content-around w-100">
                                ...
                                <!-- +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++ -->
                                <!-- N° Tarj Profesional Input text -->
                                <div class="col-10 col-md-3 form-group">
                                    <label class="requerido" for="tarjeta_prof">N° Tarj Profesional</label>
                                    <input type="text" class="form-control form-control-sm text-center" name="tarjeta_prof"
                                        id="tarjeta_prof" aria-describedby="helpId" placeholder="" required>
                                    <small id="helpId" class="form-text text-muted">N° Tarj Profesional</small>
                                </div>
                                <!-- +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++ -->
                                <!-- Soporte Date text -->
