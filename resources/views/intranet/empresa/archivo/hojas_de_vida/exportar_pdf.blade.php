...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{ base_path() . '/css/intranet/bootstrap.min.css' }}">


</head>

<body>
    <div class="row d-flex justify-content-around p-3 m-3" style="border: solid 1px black;border-radius: 5px;">
                    ...
                    <div class="row">
                        <div class="col-12 d-flex justify-content-center">
                            <img class="img-fluid img-thumbnail"
                                src="{{ public_path('imagenes/hojas_de_vida/usuario-inicial.jpg') }}" alt=""
