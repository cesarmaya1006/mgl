        ...
        <div class="card-header">
            <div class="row mb-3">
                <div class="col-12 col-md-6 col-lg-6 text-md-left text-lg-left pl-2">
                    <h5>Políticas, Reglamentos y otros</h5>
                </div>
                <div class="col-12 col-md-6 col-lg-6 text-md-right text-lg-right pl-2 pr-md-5 pr-lg-5">
                        ...
                        <a href="{{ route('politica-crear', ['id' => $id]) }}"
                            class="btn btn-success btn-sm text-center pl-3 pr-3"><i class="fas fa-plus-circle"></i> Nueva
                            Política, Reglamento y otros</a>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center"><a
                                        href="{{ asset('documentos/doc_empleados/' . $politica->documento) }}"
                                        target="_blank">{{ $politica->nom_documento }}</a></td>
                                <td class="text-center">
                                    <form
                                        action="{{ route('politica-eliminar', ['id' => $politica->id]) }}"
