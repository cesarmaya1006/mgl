                                ...
                                @foreach ($soportes as $soporte)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <form action="{{ route('sit_lab_gen-eliminar', ['id' => $soporte->id]) }}"
