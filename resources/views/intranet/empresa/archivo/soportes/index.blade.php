        ...
        <div class="card-header">
            ...
            <!-- <div class="row row d-flex justify-content-around mt-3">
                                        <div class="col-10 col-md-5">
                                            ...
                                            <input type="text" name="apellido" id="apellido" class="form-control" data_url="{{ route('soportes_afiliacion-filtar') }}" ruta_editar="{{ route('soportes_afiliacion-editar', ['id' => 1]) }}" placeholder="" aria-describedby="helpId">
                                            </div>
                                        </div>
                                    </div> -->
            <hr>
                            ...
                            @foreach ($empleados as $empleado)
                                <tr>
                                    ...
                                    <td class="text-center"><a
                                            href="{{ route('soportes_afiliacion-editar', ['id' => $empleado->id]) }}"
