                                ...
                                @foreach ($soportes as $soporte)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <form action="{{ route('vacaciones-eliminar', ['id' => $soporte->id]) }}"
