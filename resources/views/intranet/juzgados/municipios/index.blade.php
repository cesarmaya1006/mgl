            ...
            <table class="table table-striped table-hover table-sm display">
                ...
                <tbody id="contenido_tabla_data_1">
                    @foreach ($municipios as $data)
                        <tr>
                            <td>{{ $data->id }}</td>
                            <td>{{ $data->circuitos->distritos->departamentos->departamento }}</td>
                            <td>{{ $data->circuitos->distritos->distrito }}</td>
                            <td>{{ $data->circuitos->circuito }}</td>
